...
if __name__ == '__main__':
    ...
    for epoch in range(num_epochs):
        ...
        if epoch % 50 == 49:
            ...
            df_all.to_csv('/Users/ligk2e/Desktop/tmp/gan/df_all_epoch{}.csv'.format(i+1), index=None)

        c_epoch += 1

        # save the running data
        run = [array1,array2,array3,array4,array5]
        import pickle
        with open('/Users/ligk2e/Desktop/tmp/gan/run_data.p','wb') as f:
            pickle.dump(run,f)
        ...
        for e in range(100,1050,50):
            print(e)
            generate = pd.read_csv('/Users/ligk2e/Desktop/tmp/gan/df_all_epoch{}.csv'.format(str(e)))
            ...
            df_f = pd.DataFrame({'pseudo':col1,'max':col3,'comment':col2})
            df_f.to_csv('/Users/ligk2e/Desktop/tmp/gan/df/df_all_epoch{}_result.txt'.format(str(e)),sep='\t',index=None)
            ...
            plt.savefig('/Users/ligk2e/Desktop/tmp/gan/plot/df_all_epoch{}.pdf'.format(str(e)),bbox_inches='tight')
