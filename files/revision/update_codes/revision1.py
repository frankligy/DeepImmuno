...
fig,ax = plt.subplots()
sns.boxplot(x='type',y='value',hue='ID',data=total_non_01,ax=ax)
plt.savefig('/Users/ligk2e/Desktop/immuno3/revision/comp_shuffle_non01.pdf',bbox_inches='tight')
plt.close()

fig,ax = plt.subplots()
sns.violinplot(x='type',y='value',hue='ID',data=total_01)
plt.savefig('/Users/ligk2e/Desktop/immuno3/revision/comp_shuffle_01.pdf',bbox_inches='tight')
